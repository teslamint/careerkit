...
> **공개 `careerkit` 저장소를 보고 계신다면**: 그 저장소는 비공개 개발 저장소에서
> 내보낸 스냅샷이고 이슈 트래커가 꺼져 있습니다. 아래 절차는 개발 저장소에
> 접근 권한이 있는 사람을 위한 것이며, 스냅샷 쪽으로 보낸 Pull Request는 병합되지
> 않습니다. 스냅샷을 자유롭게 fork 해서 쓰셔도 됩니다(MIT).
